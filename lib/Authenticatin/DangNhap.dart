...
import '../Setting/QuenMatKhau.dart';
import 'DangKy.dart';
...
class _DangnhapState extends State<Dangnhap> {
  ...
  Future<void> _loginUser() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (user != null) {
        await UserHelper.setCurrentUser(
          user.userID!,
          user.name,
          user.phone,
          user.role,
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => const QuenMK()),
                            );
                          },
                          child: const Text(
                            'Quên mật khẩu ?',
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          ...
                          child: const Text('Đăng ký ngay', style: TextStyle(fontSize: 18, color: Colors.redAccent)),
                        ),
                      ],
                    ),
                  ],
